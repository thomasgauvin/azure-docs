...
- **Integrated API** support provided by Azure Functions with the option to link an existing Azure Functions app, Azure Web App, Azure Container App or Azure API Management instance using a standard account.
